...
function create_user_profile(object $conn,string $username1,string $password1,string $onoma, string $lastname,string $phonenum,string $salt,string $pepper){
    set_user_profile($conn,$username1,$password1,$onoma,$lastname,$phonenum,$salt,$pepper);
}
